...
const ProductList = () => {
  ...
  const filteredProducts = products
    ...
    .sort((a, b) => filterOption === 'shopname' ? a.shopname.localeCompare(b.shopname) : new Date(b.createdAt) - new Date(a.createdAt));
        ...
        <div className=" rounded-lg shadow-lg px-3">
          ...
          {loading ? (
            <div className="flex justify-center items-center py-10 h-full">
              ...
              <PacmanLoader color="#E6EBEA" height={50} width={50} />
            </div>
          ) : (
